...
#		define UNITY_METRO 1
#		define UNITY_METRO_8_1 (_MSC_VER == 1800 && WINAPI_FAMILY != WINAPI_FAMILY_PHONE_APP)
#		define UNITY_WP_8_1 (_MSC_VER == 1800 && WINAPI_FAMILY == WINAPI_FAMILY_PHONE_APP)
#		define UNITY_UAP (_MSC_VER == 1900)
#	endif
